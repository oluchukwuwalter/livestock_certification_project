...
color: #abda0f;
  ...
  <body style="background-image:url(images/background.png); background-repeat:repeat; padding-bottom:0px; margin-bottom:0px;">
    ...
    <div class="container" style="padding:10px;">
		...
		<h3 style="font-family:Georgia; color:#fff; text-align:center; font-size:16px; font-weight:bold; padding:0px; margin-top:10px;">PLANT QUARANTINE DEPARTMENT </h3>
		<h3 style=" font-family:'Times New Roman'; color:#fff; text-align:center; font-size:12px; font-weight:lighter; padding:0px; margin-top:10px;">APPLICATION FOR EXAMINATION & CERTIFICATION
OF PLANTS FOR EXPORT </h3>
		<span style="display:block; padding:5px; border: #00CC33 1px solid; border-radius:4px; width:150px; float:right; color:#CCC; text-align:center; font-size:12px; margin-right:20px;">Agric Form 48</span>
		</div>
		
	<div class="container" style="padding-bottom:20px;">
	<h2 style="font-family:candara; color:#999; font-size:14px; margin:0px; padding-top:10px; font-weight:bold; display:block; background:#A9D18E; margin-top:20px; padding:5px; width:80%; box-shadow: -2px 2px 2px 2px #999; color:#385623; text-align:center; margin-bottom:20px; ">FAST TRACK APPLICATION FORM </h2>
		...
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Full name of applicant</span>
		</div>
		<div class="col-md-7">
		<input type="text" class="form-control" style="border-radius:0px; height:20px; border:#003300 1px solid">
		</div>
		</div>
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100;  color:#666; padding:0px; margin:0px;">Address of applicant</span>
		</div>
		<div class="col-md-7">
		<input type="text" class="form-control" style="border-radius:0px; height:20px; border:#003300 1px solid">
		</div>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Phone no.</span>
		</div>
		<div class="col-md-7">
		<input type="number" class="form-control" style="border-radius:0px; height:20px; border:#003300 1px solid">
		</div>
		</div>
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Name of consignee</span>
		</div>
		<div class="col-md-7">
		<input type="text" class="form-control" style="border-radius:0px; height:20px; border:#003300 1px solid">
		</div>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Address of consignee</span>
		</div>
		<div class="col-md-7">
		<input type="text" class="form-control" style="border-radius:0px; height:20px; border:#003300 1px solid">
		</div>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Country of destination</span>
		</div>
		<div class="col-md-7">
		<select  style="border: #006633 solid 1px; border-radius:0px; height:30px;" class="form-control">         
...
<option>Zimbabwe</option>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Quantity</span>
		</div>
		<div class="col-md-7">
		<input type="text" class="form-control" style="border-radius:0px; height:20px; border:#003300 1px solid">
		</div>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Botanical name</span>
		</div>
		<div class="col-md-7">
		<input type="text" class="form-control" style="border-radius:0px; height:20px; border:#003300 1px solid">
		</div>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Description of package</span>
		</div>
		<div class="col-md-7">
		<textarea class="form-control" style="border-radius:0px; height:70px; border:#003300 1px solid"></textarea>
		</div>
		</div>
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Number of package</span>
		</div>
		<div class="col-md-7">
		<input type="text" class="form-control" style="border-radius:0px; height:20px; border:#003300 1px solid">
		</div>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Distinguishing mark</span>
		</div>
		<div class="col-md-7">
		<input type="text" class="form-control" style="border-radius:0px; height:20px; border:#003300 1px solid">
		</div>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Means of conveyance</span>
		</div>
		<div class="col-md-7">
		<input type="text" class="form-control" style="border-radius:0px; height:20px; border:#003300 1px solid">
		</div>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Place of conveyance</span>
		</div>
		<div class="col-md-7">
		<input type="text" class="form-control" style="border-radius:0px; height:20px; border:#003300 1px solid">
		</div>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Point of entry</span>
		</div>
		<div class="col-md-7">
		<select class="form-control" style="border-radius:0px; height:30px; border:#003300 1px solid">
		<option>Sea</option>
		<option>Land</option>
		</select>
		</div>
		...
		<h3 style="font-family:candara; font-size:12px; color:#006633; font-weight:bold; margin-left:20px;">  Declaration </h3>
		...
		<h3 style="font-family:candara; font-size:12px; color:#006633; font-weight:bold; margin-left:20px;">  Terms and conditions of service  </h3>
	  ...
	  <button type="submit" style=" font-family:calibri; background:#003300; border:none; color:#fff; margin-bottom:20px; border-radius:5px; padding:2px; width:100px; margin-right:20px;">Submit &gt; &gt;</button>
	</div>
		</div>
      </div>
