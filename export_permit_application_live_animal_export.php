...
color: #abda0f;
  ...
  <body style="background-image:url(images/background.png); background-repeat:repeat; padding-bottom:0px; margin-bottom:0px;">
    ...
    <div class="container" style="padding:10px;">
		...
		DEPARTMENT OF VETERINARY & PEST CONTROL SERVICES </h3>
		<h3 style=" font-family:'Times New Roman'; color:#fff; text-align:center; font-size:12px; font-weight:lighter; padding:0px; margin-top:10px;">LIVE ANIMAL EXPORT FORM</h3>
...
<option>Zimbabwe</option>
		...
		<div class="col-md-8">
		<span style="text-align:right; padding:5px; float:left; margin:auto">
		<select   style="height:30px; border: #006633 solid 1px; border-radius:0px;" class="form-control">
		...
		<span style="text-align:right; padding:5px; float:left; margin:auto">
		<select   style="height:30px; border: #006633 solid 1px; border-radius:0px;" class="form-control">
		<option>Specie 1</option>
		<option>Specie 2</option>
		</select></span>
		</div>
		</div>
		...
		<div class="row" style="margin:auto;">
		<div class="col-md-4">
		<span style="text-align:right; padding:5px; float:left; margin:auto; width:150px;font-family:candara; font-size:12px"> Tattoo (If Any)</span>
		</div>
		<div class="col-md-8">
		<span style="text-align:right; padding:5px; float:left; margin:auto"><input type="text"  style="height:20px; border: #006633 solid 1px; border-radius:0px;" class="form-control"></span>
		</div>
