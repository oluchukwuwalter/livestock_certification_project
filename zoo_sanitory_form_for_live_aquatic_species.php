...
color: #abda0f;
  ...
  <body style="background-image:url(images/background.png); background-repeat:repeat; padding-bottom:0px; margin-bottom:0px;">
    ...
    <div class="container" style="padding:10px;">
		...
		<h3 style="font-family:Georgia; color:#fff; text-align:center; font-size:16px; font-weight:bold; padding:0px; margin-top:10px;">
		AQUATIC QUARANTINE DEPARTMENT
		 </h3>
...
OF AQUATIC RESOURCE FOR IMPORT </h3>
		
		</div>
		
	<div class="container" style="padding-bottom:20px;">
	<h2 style="font-family:candara; color:#999; font-size:14px; margin:0px; padding-top:10px; font-weight:bold; display:block; background:#A9D18E; margin-top:20px; padding:5px; width:80%; box-shadow: -2px 2px 2px 2px #999; color:#385623; text-align:center; margin-bottom:20px; ">
	ZOO-SANITARY FORM FOR LIVE AQUATIC SPECIES </h2>
		...
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Name & Address Exporter (Default)</span>
		</div>
		<div class="col-md-7">
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100;  color:#666; padding:0px; margin:0px;">Email & Telephone of Exporter (Default)</span>
		</div>
		<div class="col-md-7">
		<input type="email" class="form-control" style="border-radius:0px; height:20px; border:#003300 1px solid">
		</div>
		</div>
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Description of Product/Common Name</span>
		</div>
		<div class="col-md-7">
		<input type="text" class="form-control" style="border-radius:0px; height:20px; border:#003300 1px solid">
		</div>
...
<option>Zimbabwe</option>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Purpose of Export</span>
		</div>
		<div class="col-md-7">
		<select  style="border: #006633 solid 1px; border-radius:0px; height:30px;" class="form-control">         
...
<option>Albania</option>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Country of Origin</span>
		</div>
		<div class="col-md-7">
		<select  style="border: #006633 solid 1px; border-radius:0px; height:30px;" class="form-control">         
...
<option>Zimbabwe</option>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Species Scientific Name</span>
		</div>
		<div class="col-md-7">
		<input type="text" class="form-control" style="border-radius:0px; height:20px; border:#003300 1px solid">
		</div>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">HS-Code</span>
		</div>
		<div class="col-md-7">
		<select  style="border: #006633 solid 1px; border-radius:0px; height:30px;" class="form-control">         
...
<option>Albania</option>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Processing Code</span>
		</div>
		<div class="col-md-7">
		<input type="text" class="form-control" style="border-radius:0px; height:20px; border:#003300 1px solid">
		</div>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Type of Packaging</span>
		</div>
		<div class="col-md-7">
		<input type="text" class="form-control" style="border-radius:0px; height:20px; border:#003300 1px solid">
		</div>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;"> Number of packaging</span>
		</div>
		<div class="col-md-7">
		<input type="text" class="form-control" style="border-radius:0px; height:20px; border:#003300 1px solid">
		</div>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;"> Net Weight</span>
		</div>
		<div class="col-md-7">
		<input type="text" class="form-control" style="border-radius:0px; height:20px; border:#003300 1px solid">
		</div>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;"> Name & Address of Origin</span>
		</div>
		<div class="col-md-7">
		<input type="text" class="form-control" style="border-radius:0px; height:20px; border:#003300 1px solid">
		</div>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Registration Number of Source</span>
		</div>
		<div class="col-md-7">
		<input type="text" class="form-control" style="border-radius:0px; height:20px; border:#003300 1px solid">
		</div>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Sanitary Status of Source</span>
		</div>
		<div class="col-md-7">
		<input type="text" class="form-control" style="border-radius:0px; height:20px; border:#003300 1px solid">
		</div>
		...
		<div class="row" style="margin:auto; padding-top:10px;">
		<div class="col-md-5">
		<span style="font-family:candara; font-weight:100; color:#666; padding:0px; margin:0px;">Means of Transportation</span>
		</div>
		<div class="col-md-7">
	  ...
	  <button type="submit" style=" font-family:calibri; background:#003300; border:none; color:#fff; margin-bottom:20px; border-radius:5px; padding:2px; width:100px">Submit &gt; &gt;</button>
	</div>
		</div>
      </div>
