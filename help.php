   ...
   <?php include('header.php'); ?>
	...
	<div class="col-md-3"></div>
      ...
      <div class="row" style="padding-right:0px; margin-right:0px;">
        <div class="col-md-3"></div>
        <div class="col-md-6" style="background:#E2F0D9;box-shadow: -2px 2px 2px 2px #999; border:#00CC33 1px solid;  margin-bottom:50px; padding-bottom:50px; min-height:300px;">
		
		
		<h4 style="text-align:center">Help page is coming soon...</h4>
