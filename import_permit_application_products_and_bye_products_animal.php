...
color: #abda0f;
  ...
  <body style="background-image:url(images/background.png); background-repeat:repeat; padding-bottom:0px; margin-bottom:0px;">
    ...
    <div class="container" style="padding:10px;">
		...
		<h3 style=" font-family:'Times New Roman'; color:#fff; text-align:center; font-size:12px; font-weight:lighter; padding:0px; margin-top:10px;">PRODUCTS & BY-PRODUCTS OF ANIMAL ORIGIN IMPORT FORM</h3>
...
Import Permit Application Form . </h2>
	...
	<div class="row" style="margin:auto;">
		...
		<div class="col-md-8">
		<span style="text-align:right; padding:5px; float:left; margin:auto">
		<input type="number"  style="height:20px; border: #006633 solid 1px; width:136%;"></span>
		</div>
		</div>
