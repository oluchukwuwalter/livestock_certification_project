...
color: #abda0f;
  ...
  <body style="background-image:url(images/background.png); background-repeat:repeat; padding-bottom:0px; margin-bottom:0px;">
    ...
    <div class="container" style="padding:10px;">
		...
		<h3 style="font-family:Georgia; color:#fff; text-align:center; font-size:16px; font-weight:bold; padding:0px; margin-top:10px;">DEPARTMENT OF VETERINARY & PEST CONTROL SERVICES </h3>
		<h3 style=" font-family:'Times New Roman'; color:#fff; text-align:center; font-size:12px; font-weight:lighter; padding:0px; margin-top:10px;">ANIMAL VACCINES, INFECTIOUS AGENTS & OTHER BIOLOGICALS EXPORT APPLICATION FORM</h3>
		
		</div>
		
	<div class="container" style="padding-bottom:20px;">
	<h2 style="font-family:candara; color:#999; font-size:14px; margin:0px; padding-top:10px; font-weight:bold; ">
Export Permit Application  Form . </h2>
	...
	<h3 style="font-family:candara; font-size:12px; color:#006633; font-weight:bold; margin-left:20px;"> 1.  Exporter’s Details </h3>
	<div class="container">
	<div class="col-md-6">
	...
	<div class="row" style="margin:auto;">
		...
		<div class="row" style="margin:auto;">
		<div class="col-md-4">
		<span style="text-align:right; padding:5px; float:left; margin:auto; width:150px;font-family:candara; font-size:12px">Country of Destination</span>
		</div>
		<div class="col-md-8">
		<span style="text-align:right; padding:5px; float:left; margin:auto">
...
<option>Zimbabwe</option>
		...
		<h3 class="legend-header">2. Description of Consignment </h3>
		
		
		<div class="col-md-6" style="margin:auto; text-align:center">
		<div class="row" style="margin:auto;">
		<div class="col-md-4">
		<span style="text-align:right; padding:5px; float:left; margin:auto; width:150px;font-family:candara; font-size:12px">Vaccine/Biological Material/Infectious Agent</span>
		</div>
		<div class="col-md-8">
		<span style="text-align:right; padding:5px; float:left; margin:auto"><input type="text"  style="height:20px; border: #006633 solid 1px; border-radius:0px;" class="form-control"></span>
		</div>
		...
		<div class="row" style="margin:auto;">
		<div class="col-md-4">
		<span style="text-align:right; padding:5px; float:left; margin:auto; width:150px;font-family:candara; font-size:12px"> Type of Product</span>
		</div>
		<div class="col-md-8">
		<span style="text-align:right; padding:5px; float:left; margin:auto">
		<input type="text"  style="height:20px; border: #006633 solid 1px; border-radius:0px;" class="form-control"></span>
		...
		<div class="row" style="margin:auto;">
		<div class="col-md-4">
		<span style="text-align:right; padding:5px; float:left; margin:auto; width:150px;font-family:candara; font-size:12px">  Laboratory of Origin</span>
		</div>
		<div class="col-md-8">
		<span style="text-align:right; padding:5px; float:left; margin:auto"><input type="text"  style="height:20px; border: #006633 solid 1px; border-radius:0px;" class="form-control"></span>
		</div>
		...
		<div class="row" style="margin:auto;">
		<div class="col-md-4">
		<span style="text-align:right; padding:5px; float:left; margin:auto; width:150px;font-family:candara; font-size:12px">Shelf Life</span>
		</div>
		<div class="col-md-8">
		<span style="text-align:right; padding:5px; float:left; margin:auto"><input type="text"  style="height:20px; border: #006633 solid 1px; border-radius:0px;" class="form-control"></span>
		</div>
		...
		<div class="row" style="margin:auto;">
		<div class="col-md-4">
		<span style="text-align:right; padding:5px; float:left; margin:auto; width:150px;font-family:candara; font-size:12px"> Manufacture Date  </span>
		</div>
		<div class="col-md-8">
		<span style="text-align:right; padding:5px; float:left; margin:auto">
		<input type="text"  style="height:20px; border: #006633 solid 1px; border-radius:0px;" class="form-control">
		</span>
		</div>
		</div>
		...
		<div class="row" style="margin:auto;">
		<div class="col-md-4">
		<span style="text-align:right; padding:5px; float:left; margin:auto; width:150px;font-family:candara; font-size:12px">  Expiry Date	</span>
		</div>
		<div class="col-md-8">
		<span style="text-align:right; padding:5px; float:left; margin:auto"><input type="text"  style="height:20px; border: #006633 solid 1px; border-radius:0px;" class="form-control"></span>
		</div>
		...
		<div class="row" style="margin:auto;">
		<div class="col-md-4">
		<span style="text-align:right; padding:5px; float:left; margin:auto; width:150px;font-family:candara; font-size:12px">Purpose of Exportation  </span>
		</div>
		<div class="col-md-8">
		<span style="text-align:right; padding:5px; float:left; margin:auto"><input type="text"  style="height:20px; border: #006633 solid 1px; border-radius:0px;" class="form-control"></span>
		</div>
