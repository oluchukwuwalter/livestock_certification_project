...
color: #abda0f;
  ...
  <body style="background-image:url(images/background.png); background-repeat:repeat; padding-bottom:0px; margin-bottom:0px;">
    ...
    <div class="container" style="padding:10px;">
		...
		<h3 style=" font-family:'Times New Roman'; color:#fff; text-align:center; font-size:12px; font-weight:lighter; padding:0px; margin-top:10px;">APPLICATION FOR EXAMINATION & CERTIFICATION OF PLANTS FOR EXPORTATION </h3>
	...
	<h2 style="font-family:candara; color:#999; font-size:14px; margin:0px; padding-top:10px; font-weight:bold; ">Application Form for Fast Track/Commercial Export. </h2>
	...
	<div class="row" style="margin:auto;">
		<div class="col-md-4">
		<span style="text-align:right; padding:5px; float:left; margin:auto; width:150px;font-family:candara; font-size:12px">Name of exporter*</span>
		</div>
		<div class="col-md-8">
		...
		<div class="row" style="margin:auto;">
		<div class="col-md-4">
		<span style="text-align:right; padding:5px; float:left; margin:auto; width:150px;font-family:candara; font-size:12px">Address of exporter *</span>
		</div>
		<div class="col-md-8">
		<span style="text-align:right; padding:5px; float:left; margin:auto"><input type="text"  style="height:20px; border: #006633 solid 1px; border-radius:0px;" class="form-control"></span>
		</div>
		...
		<div class="row" style="margin:auto;">
		<div class="col-md-4">
		<span style="text-align:right; padding:5px; float:left; margin:auto; width:150px;font-family:candara; font-size:12px"> Country of import *</span>
		</div>
		<div class="col-md-8">
...
<option>Zimbabwe</option>
	...
	<div class="row" style="margin:auto;">
		...
		<div class="row" style="margin:auto;">
		<div class="col-md-4">
		<span style="text-align:right; padding:5px; float:left; margin:auto; width:150px;font-family:candara; font-size:12px">Address of consignee *</span>
		</div>
		<div class="col-md-8">
		<span style="text-align:right; padding:5px; float:left; margin:auto"><input type="text"  style="height:20px; border: #006633 solid 1px; border-radius:0px;" class="form-control"></span>
		</div>
		...
		<h3 class="legend-header">2. Plant details </h3>
		
		<div class="col-md-3"></div>
		<div class="col-md-6" style="margin:auto; text-align:center">
		<div class="row" style="margin:auto;">
		<div class="col-md-4">
		<span style="text-align:right; padding:5px; float:left; margin:auto; width:150px;font-family:candara; font-size:12px">Name of plant or plant</span>
		</div>
		<div class="col-md-8">
		<span style="text-align:right; padding:5px; float:left; margin:auto"><input type="text"  style="height:20px; border: #006633 solid 1px; border-radius:0px;" class="form-control"></span>
		</div>
		...
		<div class="row" style="margin:auto;">
		<div class="col-md-4">
		<span style="text-align:right; padding:5px; float:left; margin:auto; width:150px;font-family:candara; font-size:12px">Quantity</span>
		</div>
		<div class="col-md-8">
		<span style="text-align:right; padding:5px; float:left; margin:auto"><input type="text"  style="height:20px; border: #006633 solid 1px; border-radius:0px;" class="form-control"></span>
		</div>
		...
		<div class="row" style="margin:auto;">
		<div class="col-md-4">
		<span style="text-align:right; padding:5px; float:left; margin:auto; width:150px;font-family:candara; font-size:12px">Botanical name plant</span>
		</div>
		<div class="col-md-8">
		<span style="text-align:right; padding:5px; float:left; margin:auto"><input type="text"  style="height:20px; border: #006633 solid 1px; border-radius:0px;" class="form-control"></span>
		</div>
		...
		<div class="row" style="margin:auto;">
		<div class="col-md-4">
		<span style="text-align:right; padding:5px; float:left; margin:auto; width:150px;font-family:candara; font-size:12px">Description of package</span>
		</div>
		<div class="col-md-8">
		<span style="text-align:right; padding:5px; float:left; margin:auto"><textarea type="text"  style="height:60px; border: #006633 solid 1px; border-radius:0px;" class="form-control"></textarea></span>
		</div>
		</div>
		<div class="row" style="margin:auto;">
		<div class="col-md-4">
		<span style="text-align:right; padding:5px; float:left; margin:auto; width:150px;font-family:candara; font-size:12px">Number of package</span>
		</div>
		<div class="col-md-8">
		<span style="text-align:right; padding:5px; float:left; margin:auto"><input type="text"  style="height:20px; border: #006633 solid 1px; border-radius:0px;" class="form-control"></span>
		</div>
		...
		<div class="row" style="margin:auto;">
		<div class="col-md-4">
		<span style="text-align:right; padding:5px; float:left; margin:auto; width:150px;font-family:candara; font-size:12px"> Distinguishing mark</span>
		</div>
		<div class="col-md-8">
		<span style="text-align:right; padding:5px; float:left; margin:auto"><input type="text"  style="height:20px; border: #006633 solid 1px; border-radius:0px;" class="form-control"></span>
		</div>
		...
		<div class="row" style="margin:auto;">
		<div class="col-md-4">
		<span style="text-align:right; padding:5px; float:left; margin:auto; width:150px;font-family:candara; font-size:12px">Place of origin</span>
		</div>
		<div class="col-md-8">
		<span style="text-align:right; padding:5px; float:left; margin:auto">
		<select  style="border: #006633 solid 1px; border-radius:0px;" class="form-control">         
		...
		<div class="row" style="margin:auto;">
		<div class="col-md-4">
		<span style="text-align:right; padding:5px; padding-right:10px; float:left; margin:auto; width:150px;font-family:candara; font-size:12px">Fast track location</span>
		</div>
		<div class="col-md-8">
		<span style="text-align:right; padding:5px; float:left; margin:auto">
		<select  style="border: #006633 solid 1px; border-radius:0px;" class="form-control">         
